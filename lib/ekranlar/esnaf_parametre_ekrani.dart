      ...
      body: ListView(
        ...
        children: [
          ...
          if (_esnaf!.kategori == 'Araç Kiralama')
            ...
            // 1. RANDVEU YÖNETİM AYARLARI KARTI
            _parametreKart(
              ...
              icerik: Column(
                children: [
                  ...
                  if (!_esnaf!.randevuAlinmasin) ...[
                    ...
                    const Align(
                      alignment: Alignment.centerLeft,
                      child: Text("Yeni randevular otomatik mi onaylansın yoksa sizin onayınız mı beklensin?", style: TextStyle(fontSize: 13, color: Colors.grey)),
                    ),
                    const SizedBox(height: 10),
                    DropdownButtonFormField<String>(
                      ...
                      items: const [
                        DropdownMenuItem(value: 'Manuel', child: Text("Manuel (Ben onaylayacağım)", style: TextStyle(fontSize: 15))),
                        DropdownMenuItem(value: 'Otomatik', child: Text("Otomatik (Anında onaylansın)", style: TextStyle(fontSize: 15))),
                      ],
                      onChanged: (v) {
                        if (v != null) {
            ...
            // 2. AJANDA VE PLANLAMA AYARLARI KARTI
            _parametreKart(
              ...
              icerik: Column(
                ...
                children: [
                  SwitchListTile(
                    ...
                    subtitle: const Text("İşaretli olursa ajanda defterini manuel hazırlamanız gerekir. İşaretsiz olursa tam otomatik canlı sistem aktif olur."),
                  ...
                  if (!_esnaf!.ajandayiKendimAyarlayacagim) ...[
                    ...
                    const Text("Müşteriler bugünden itibaren en fazla kaç gün ilerisi için randevu alabilir?", style: TextStyle(fontSize: 13, color: Colors.grey)),
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        Expanded(
                  ...
                  if (_esnaf!.kategori != 'Araç Kiralama') ...[
                    ...
                    SwitchListTile(
                      ...
                      subtitle: const Text("Randevu saatleri '10:00' yerine '10:00 - 11:00' şeklinde aralıklı gösterilir (Örn: Halı Sahalar için)."),
            ...
            // 3. PERSONEL VE HİZMET AKIŞI KARTI
            if (_esnaf!.kategori != 'Araç Kiralama')
              _parametreKart(

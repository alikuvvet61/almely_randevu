...
class AracKiralamaMusteriEkrani extends StatefulWidget {
  final EsnafModeli esnaf;
  final String? kullaniciTel;

  const AracKiralamaMusteriEkrani({super.key, required this.esnaf, this.kullaniciTel});

  @override
  State<AracKiralamaMusteriEkrani> createState() => _AracKiralamaMusteriEkraniState();
}

class _AracKiralamaMusteriEkraniState extends State<AracKiralamaMusteriEkrani> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_guncelEsnaf.araclar.isNotEmpty && _guncelEsnaf.aracOdakliSistem) ...[
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Builder(builder: (context) {
                            ...
                            final duraktakiAraclar = tumAraclar
                                .where((a) => !_istirahatKontrol(a) && a['durakta'] == true)
                                .toList();
                                        ...
                                        child: Row(
                                          children: [
                                            Icon(
                                              ...
                                              color: istirahatli
                                                  ? Colors.red
                                                  : (durakta ? Colors.blue : Colors.green),
                                            ),
                  ...
                  if (!_guncelEsnaf.randevuAlinmasin && _guncelEsnaf.kanallar != null && _guncelEsnaf.kanallar!.isNotEmpty) ...[
                    const SizedBox(height: 25),
                ...
                onPressed: () {
                  ...
                  if (ajandaVarMi) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (c) => AracKiralamaYonlendirme.randevuEkrani(
                          esnaf: _guncelEsnaf,
